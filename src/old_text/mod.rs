...
pub struct TextLayout<'a, Font, Unit = f64> {
    inner: Cow<'a, str>,
    /// Has color, font, and position
    style: TextStyle<'a, Font, Unit>,
}

impl<'a, F, U> TextLayout<'a, F, U> {
...
"#]
impl<'font, Font, Unit> Drawable<BoundingBox<Unit>> for TextLayout<Font, Unit>
where
...
impl XmlComp for TextLayout<PresetFont> {
